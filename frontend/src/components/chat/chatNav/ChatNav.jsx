...
import LogoChat from "../../logoChat/LogoChat.jsx";
import ChatNavitem from "./ChatNavitem.jsx";
  ...
  return (
    <>
      <nav
        ...
        style={{ minWidth: "80px" }}
      >
        <Link to={"/chat"} className="d-none d-xl-block mb-6">
          <LogoChat />
        </Link>
        <ul
        ...
        >
          <ChatNavitem
            to={"/chat"}
            className={"d-none d-xl-block invisible flex-xl-grow-1"}
          >
            <svg
          ...
          <ChatNavitem
            to={"/chat"}
            className="d-none d-xl-block flex-xl-grow-1"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
